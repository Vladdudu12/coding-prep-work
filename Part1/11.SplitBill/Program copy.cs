...
//     {
//         List<decimal> splitAmounts = new List<decimal>();
//         var amount = Math.Round(decimal.Divide(totalAmount, numberOfPeople), 2, MidpointRounding.AwayFromZero);
//         for (int i = 0; i < numberOfPeople; i++)
//         {
//             splitAmounts.Add(amount);
//         }

//         if (totalAmount.CompareTo(splitAmounts.Sum()) != 0)
//         {
//             Random rnd = new Random();
//             int randomPos = rnd.Next(0, numberOfPeople);
//             splitAmounts[randomPos] += totalAmount - splitAmounts.Sum();
//         }
